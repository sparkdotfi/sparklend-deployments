...
contract SparkMigrationHelper is MigrationHelper {
    ...
    IERC20WithPermit public constant STETH = IERC20WithPermit(0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84);
    ...
    function getMigrationSupply(address asset, uint256 amount) external view override returns (address, uint256) {
