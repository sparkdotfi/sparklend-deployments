...
/**
 * @title ERC20Mintable
 * @dev ERC20 minting logic w/ limit
 */
contract MintableLimitERC20 is IERC20WithPermit, ERC20 {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 mintLimit_) ERC20(name, symbol) {
    ...
    function mint(uint256 value) public returns (bool) {
        require(balanceOf(_msgSender()) + value <= mintLimit, "MINT_LIMIT_EXCEEDED");
